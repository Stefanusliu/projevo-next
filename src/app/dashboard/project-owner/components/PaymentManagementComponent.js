...
export default function PaymentManagementComponent() {
  ...
  useEffect(() => {
    ...
    console.log(
      "Loading project payments for user:",
      user.uid,
      "email:",
      userProfile.email
    );
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        console.log(
          "Loaded project payments for user:",
          user.uid,
          "Total payments:",
  ...
  const filteredPayments =
    selectedStatus === "all" ? payments : paymentData[selectedStatus] || [];
  ...
  const statusOptions = [
    { value: "all", label: "All Payments", count: payments.length },
    {
      ...
      count: paymentData["waiting-approval"].length,
      description: "Menunggu admin",
    },
    {
      value: "process",
      label: "Process",
      count: paymentData["process"].length,
      description: "Sedang proses",
    },
    {
      value: "inescrow",
      label: "In Escrow",
      count: paymentData["inescrow"].length,
      description: "Dana di rekening bersama",
    },
    {
      value: "release",
      label: "Release",
      count: paymentData["release"].length,
      description: "Dana ke vendor",
    },
    {
      value: "settle",
      label: "Settle",
      count: paymentData["settle"].length,
      description: "Pembayaran complete",
    },
    {
      value: "add-funds",
      label: "Add Funds",
      count: paymentData["add-funds"].length,
      description: "Request dana tambahan",
    },
    {
      value: "refund",
      label: "Refund",
      count: paymentData["refund"].length,
      description: "Dana kembali",
    },
    {
      value: "indispute",
      label: "In Dispute",
      count: paymentData["indispute"].length,
      description: "Dana di hold",
    },
    {
      value: "failed",
      label: "Failed",
      count: paymentData["failed"].length,
      description: "Gagal",
    },
    // Legacy statuses
    {
      value: "pending",
      label: "Pending",
      count: paymentData["pending"].length,
      description: "Menunggu pembayaran",
    },
    {
      value: "completed",
      label: "Completed",
      count: paymentData["completed"].length,
      description: "Selesai",
    },
    {
      value: "overdue",
      label: "Overdue",
      count: paymentData["overdue"].length,
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mb-1">
                      ...
                      {payment.vendorName || "Not specified"}
                    </p>
                    <p className="text-gray-600 mb-1">
                      <span className="font-medium">Payment Type:</span>{" "}
                      {payment.paymentType || "Payment milestone"}
                    </p>
                    <p className="text-gray-600 mb-1">
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  {payment.status === "release" && (
                    <button
                      onClick={() =>
                        alert("Funds are being released to vendor")
                      }

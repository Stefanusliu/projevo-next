...
export default function ProjectOwnerDetailModal({ project, isOpen, onClose, onEditProject }) {
  ...
  const enhancedProject = {
    ...
    projectBackground: project.projectBackground || 'Project background information.',
    ...
    designPreferences: project.designPreferences || ['Modern Design', 'Energy Efficient'],
    specificRequirements: project.specificRequirements || project.description || 'Detailed project requirements.',
    qualityStandards: project.qualityStandards || 'High Quality',
    materialPreferences: project.materialPreferences || ['Eco-Friendly', 'Durable'],
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              <div className="lg:col-span-2 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">
                    {project.description || enhancedProject.specificRequirements}
                  </p>
              ...
              <div className="space-y-6">
                ...
                {project.procurementMethod === 'Tender' && (
                  <div className="bg-slate-50 rounded-xl p-6">
                    <h3 className="text-lg font-semibold text-slate-900 mb-4">Tender Information</h3>
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm text-slate-500">Proposals Received</p>
                        <p className="text-2xl font-bold text-slate-900">{project.proposals || 0}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-slate-900">{project.bidCountdown || 'Active'}</p>
                      </div>
                    </div>
                  </div>
                )}
          ...
          {activeTab === 'proposals' && (
            <div className="space-y-6">
              ...
              <div className="text-center text-gray-500 py-8">
                <p>Detailed proposal management interface will be implemented here</p>
              </div>
            </div>
          )}
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-900">{project.createdAt ? new Date(project.createdAt.seconds * 1000).toLocaleDateString() : 'Recently'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-500">Last Updated</p>
                      <p className="text-slate-900">{project.updatedAt ? new Date(project.updatedAt.seconds * 1000).toLocaleDateString() : 'Recently'}</p>
                    </div>
                  </div>
                </div>
              </div>

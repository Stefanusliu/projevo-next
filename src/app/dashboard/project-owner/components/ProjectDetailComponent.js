...
export default function ProjectDetailComponent({
  ...
  // Create placeholder image using utility function
  const dummyImage = createPlaceholderImage("Image not available");
  ...
  const handleDeleteDocumentation = async (imageId) => {
    if (window.confirm("Apakah Anda yakin ingin menghapus dokumentasi ini?")) {
      try {
        ...
        const updatedImages = documentationImages.filter(
          (img) => img.id !== imageId
        );
        setDocumentationImages(updatedImages);
  ...
  const projectData = {
    ...
    recentActivities: [
      {
        ...
        description:
          "All interior design mockups have been approved by client with modern minimalist theme",
      ...
      },
      {
        ...
        description:
          "Interior construction work has begun with partition and ceiling installation",
      ...
      },
      {
        ...
        description:
          "Client provided input regarding material selection and room color scheme",
        user: "Budi Santoso",
    ...
    documents: [
      {
        id: 1,
        name: "Project Budget Estimate.pdf",
        size: "3.2 MB",
        uploadDate: "January 15, 2025",
      },
      {
        id: 2,
        name: "Design Drawings.dwg",
        size: "28.4 MB",
    ...
    gallery: [
      {
        id: 1,
        title: "Main Area Design Concept",
        description: "Seating area layout with modern concept",
        uploadDate: "January 20, 2025",
      ...
      },
      {
        ...
        description: "Counter concept with teak wood material",
      ...
      },
      {
        ...
        description: "Room partition installation progress",
        uploadDate: "January 22, 2025",
        url: "/api/placeholder/300/200",
      },
      {
        ...
        description: "Floor and wall material samples",
              ...
              <div className="bg-white/80 backdrop-blur-sm dark:bg-slate-800/90 rounded-2xl p-4 sm:p-6 border border-gray-200/50 dark:border-slate-700/50 shadow-lg">
                ...
                <div className="space-y-4 sm:space-y-6">
                  {projectData.recentActivities.map((activity, index) => (
                    <div
                      key={activity.id}
                      className="flex items-start space-x-3 sm:space-x-4 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors"
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                <div className="space-y-4">
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                    ...
                    <button className="text-blue-600 dark:text-blue-400 hover:underline text-sm mt-1">
                      Send Email
                    </button>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
          ...
          <div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                  Budget estimates, technical drawings, and supporting documents
                </p>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm dark:bg-slate-800/90 rounded-2xl border border-gray-200/50 dark:border-slate-700/50 shadow-lg overflow-hidden">
              {projectData.documents.map((doc, index) => (
                <div
                  key={doc.id}
                  className={`p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors ${
                    index !== projectData.documents.length - 1
          ...
          <div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                  Progress visuals and design documentation
                </p>
              </div>
              <button className="w-full sm:w-auto flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                <svg
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {projectData.gallery.map((image, index) => (
                <div
                  key={image.id}
                  className="bg-white/80 backdrop-blur-sm dark:bg-slate-800/90 rounded-2xl overflow-hidden border border-gray-200/50 dark:border-slate-700/50 group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
          ...
          <div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                  {userRole === "vendor"
                    ? "Upload dan kelola dokumentasi progress pekerjaan"
                    : "Lihat dokumentasi progress pekerjaan dari vendor"}
                </p>
              </div>
                ...
                {documentationImages.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {documentationImages.map((image, index) => {
                      const imageKey =
                        image.id || image.name || `image-${index}`;
                      ...
                      console.log("Generated clean imageUrl:", {
                        imageKey,
                        imageUrl,
                      ...
                      return (
                        <div
                          key={imageKey}
                          className="aspect-square bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden group hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 relative"
                        >
                          <Image
                            src={
                            ...
                            <div className="flex space-x-2">
                              ...
                              {userRole === "vendor" && (
                                <>
                                  <button
                                    onClick={() =>
                                      handleEditDocumentation(imageKey)
                                    }
                                  ...
                                  <button
                                    onClick={() =>
                                      handleDeleteDocumentation(imageKey)
                                    }
                    ...
                    {userRole === "vendor" && isVendorAccepted && (
                      <div
                        onClick={
                          uploadingImage ? null : handleUploadDocumentation
                        }
                      ...
                      >
                        {uploadingImage ? (
                          ...
                          <>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors font-medium">
                              Upload
                            </p>
                          </>
                        )}
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                              <h4 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                                {activity.title}
                              </h4>
      ...
      <div className="fixed top-20 left-0 right-0 h-1 bg-gray-200 dark:bg-slate-700 sm:hidden z-40">
        <div
          ...
          style={{
            width: `${
              ((tabs
                .filter((tab) => tab.id !== "dokumentasi" || isVendorAccepted)
                .findIndex((tab) => tab.id === activeTab) +
                1) /
                tabs.filter(
                  (tab) => tab.id !== "dokumentasi" || isVendorAccepted
                ).length) *
              100
            }%`,
          }}

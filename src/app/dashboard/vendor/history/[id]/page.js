    ...
    const fetchProject = async () => {
      ...
      try {
        ...
        if (projectDoc.exists()) {
          ...
          const vendorProposal = vendorProposals.find(p => p.vendorId === user.uid || p.vendorEmail === user.email);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-slate-900">{project.ownerName || project.ownerEmail?.split('@')[0] || 'N/A'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-slate-600">Company</label>
                <p className="text-slate-900">{project.companyName || project.ownerCompanyName || 'N/A'}</p>
              </div>
              <div>

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Penawaran Saya</h2>
          <p className="text-slate-600">Lacak penawaran yang telah dikirim dan statusnya</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
        ...
        <div className="bg-white rounded-lg p-4 border border-slate-200">
          ...
          <div className="text-sm text-slate-600">Diterima</div>
        </div>
        <div className="bg-white rounded-lg p-4 border border-slate-200">
        ...
        <div className="bg-white rounded-lg p-4 border border-slate-200">
          ...
          <div className="text-sm text-slate-600">Tingkat Sukses</div>
        </div>
      </div>
          ...
          >
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-500">
                    {proposal.submittedDate ? `Dikirim: ${new Date(proposal.submittedDate).toLocaleDateString()}` : 'Draft'}
                  </p>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-xs text-slate-500">
                    {proposal.competitorCount} pesaing
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-4">
                <h4 className="text-sm font-medium text-slate-900 mb-2">Penawaran Anda</h4>
              ...
              {proposal.attachments && proposal.attachments.length > 0 && (
                <div className="mb-4">
                  <h4 className="text-sm font-medium text-slate-700 mb-2">Lampiran</h4>
                  <div className="flex flex-wrap gap-2">
      ...
      {filteredProposals.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-slate-900">Tidak ada penawaran ditemukan</h3>
          <p className="text-slate-500 mt-2">
            Tidak ada penawaran yang sesuai dengan filter &quot;{activeFilter}&quot;.
          </p>
        </div>
      )}

                                  ...
                                  <tr key={`${tahapanIndex}-${jenisIndex}-${uraianIndex}-${specIndex}`} 
                                    ...
                                    <td className="px-4 py-4 text-center">
                                      <input
                                        ...
                                        className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-center text-sm font-medium bg-white text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        min="0"
                                      />
                                    </td>
                                    <td className="px-4 py-4 text-center">
                                      <input
                                        ...
                                        className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-center text-sm font-medium bg-white text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all"
                                      />
                                    </td>
                                    <td className="px-4 py-4 text-right">
                                      <input
                                        ...
                                        className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-right text-sm font-medium bg-white text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        min="0"
                                      />
                                    </td>

...
export default function ProjectDetailModal({
  ...
  console.log("ProjectDetailModalNew - project:", project);
  console.log("ProjectDetailModalNew - hasPayments:", hasPayments);
  console.log("ProjectDetailModalNew - payments array:", project?.payments);
  console.log("ProjectDetailModalNew - payment object:", project?.payment);
  ...
  const enhancedProject = {
    ...
    projectBackground:
      "Our company is expanding and needs a modern workspace that reflects our innovative culture and supports collaborative work.",
    projectGoals:
      "Create a productive, inspiring workspace that enhances employee satisfaction and company brand image.",
    ...
    accessRestrictions:
      "Akses terbatas pada jam kerja kantor, tidak mengganggu operasional existing",
    ...
    specificRequirements:
      "Ruang meeting untuk 12 orang, area kolaborasi terbuka, ruang istirahat modern, sistem keamanan terintegrasi",
    ...
    colorPreferences:
      "Warna netral dengan aksen hijau dan biru untuk menciptakan suasana tenang dan produktif",
    sustainabilityRequirements:
      "Penggunaan material ramah lingkungan, sistem pencahayaan LED hemat energi",
    accessibilityNeeds:
      "Akses ramah disabilitas sesuai standar universal design",
    ...
    specialNotes:
      "Proyek harus selesai sebelum akhir tahun untuk kebutuhan ekspansi tim",
    risksAndChallenges:
      "Koordinasi dengan operasional kantor yang sedang berjalan",
    successCriteria:
      "Workspace yang meningkatkan produktivitas tim, selesai tepat waktu, dalam budget",
  ...
  const getBidCountdownColor = (countdown) => {
    ...
    if (days <= 7) return "text-gray-600 bg-gray-50";
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Priority: {enhancedProject.budgetPriority}
                      </p>
                    </div>
                    <div>
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getMatchColor(
                          project.match
                        )}`}
                      >
                        {project.match}% Match
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getBidCountdownColor(
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-slate-900 font-medium">
                          {enhancedProject.communicationPreference}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500">Reporting:</span>
                        <span className="text-slate-900 font-medium">
                          {enhancedProject.reportingFrequency}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500">Meetings:</span>
                        <span className="text-slate-900 font-medium">
                          {enhancedProject.meetingSchedule}
                        </span>
                      </div>
                    </div>
                  </div>

...
export default function Profile() {
  ...
  const tabs = [
    ...
    { id: 'company', label: 'Company', icon: <FiHome className="w-4 h-4" /> },
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-8">
              <div className="text-center">
                <div className="relative inline-block">
                  <Avatar src={profileData.avatar} alt="Profile" name={`${profileData.firstName} ${profileData.lastName}`} size={128} className="border-4 border-blue-100 mx-auto" />
                </div>
                <h2 className="text-xl font-bold text-gray-900 mt-4">{profileData.firstName} {profileData.lastName}</h2>
                <p className="font-medium" style={{ color: '#2373FF' }}>{profileData.specialization || 'Vendor'}</p>

...
const BOQDisplay = ({ project, isVendorView = false }) => {
                                            ...
                                            {uraian.spec.map((spec, specIndex) => (
                                              <tr key={`spec-${spec.id || specIndex}`} className="border-b border-gray-200">
                                                ...
                                                <td className="px-3 py-2 text-right text-gray-800">
                                                  {formatCurrency(spec.pricePerPcs || 0)}
                                                </td>
        ...
        {isVendorView && (
          <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h5 className="font-medium text-amber-800 mb-1">BOQ Information</h5>
                <p className="text-sm text-amber-700">
                  This BOQ provides a detailed breakdown of the project scope and estimated costs. 
                  You may propose alternative solutions or materials in your proposal while maintaining the project objectives.
                </p>
              </div>
            </div>
          </div>

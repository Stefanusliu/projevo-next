              ...
              <div className="flex flex-col space-y-2 pt-4 border-t border-gray-700">
                {user ? (
                  ...
                  <>
                    <Link
                      href="/login"
                      className="text-left text-white hover:text-blue-400 font-medium"
                    >
                      Sign In
                    </Link>
                    <Link
                      href="/signup"
                      className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-all duration-200 font-medium shadow-lg text-center"
                    >
                      Sign Up
                    </Link>
                  </>

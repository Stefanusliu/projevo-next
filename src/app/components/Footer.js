...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/projevo',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/projevo',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/projevo',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-2xl font-bold">Projevo</span>
              </Link>
              <p className="text-slate-400 mb-6 leading-relaxed max-w-md">
                Transform your project management with AI-powered insights, seamless collaboration, and intelligent automation that evolves with your team.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-6">
              <p className="text-slate-400 text-sm">
                © {currentYear} Projevo. All rights reserved.
              </p>

...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check user profile periodically to redirect to appropriate dashboard
      let attempts = 0;
      const maxAttempts = 20; // Wait up to 10 seconds
      
      const checkProfileAndRedirect = () => {
        attempts++;
        console.log(`Profile check attempt ${attempts}, userProfile:`, userProfile);
        ...
        if (userProfile && userProfile.userType) {
          ...
          // User profile exists but no userType, redirect to selection
          ...
          // Timeout: user profile never loaded, redirect to user type selection
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const checkProfileAndRedirect = () => {
        attempts++;
        console.log(`Google profile check attempt ${attempts}, userProfile:`, userProfile);
        ...
        if (userProfile && userProfile.userType) {
          ...
          // Timeout: user profile never loaded, redirect to user type selection
          console.log('Google profile loading timeout, redirecting to user type selection...');
          window.location.href = '/select-user-type';
        }
      };
        ...
        <div className="relative max-w-md w-full space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            ...
            <button
              ...
              type="button"
              disabled={isLoading}
              className="w-full bg-white border-2 border-gray-300 hover:border-blue-400 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md group disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="text-sm font-medium text-black">Automatic Role Detection</h4>

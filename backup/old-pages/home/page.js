...
export default function HomePage() {
  ...
  const [projects] = useState([
    {
      ...
      title: "Modern Coffee Shop Interior Design",
    ...
    },
    {
      ...
      contractType: "Contract",
      status: "under review",
      projectStatus: "tender successfully submited"
    },
    {
      id: 4,
      ...
      contractType: "Tender",
      status: "pending",
      projectStatus: "migfrating to history"
    },
    {
      id: 5,
      projectType: "Interior Design",
      title: "Rooftop Bar Interior",
      location: "SCBD Jakarta",
      profileName: "Design Excellence",
      contractType: "Contract",
      status: "on going",
      projectStatus: "sign contract"
    },
    {
      id: 6,
      projectType: "Construction",
      ...
      contractType: "Tender",
      status: "rejected",
      projectStatus: "tender submission rejected by client"
    }
  ]);
  ...
  const getProjectStatusColor = (status) => {
    switch (status) {
      ...
      case 'tender successfully submited':
        return 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400';
      case 'migfrating to history':
        return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400';
      case 'sign contract':
        return 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/20 dark:text-emerald-400';
      case 'tender submission rejected by client':
        return 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400';
      default:
        return 'bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400';
    }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white">All Project</h1>
            ...
            <div className="space-y-3">
              {projects.map((project) => (
                <div key={project.id} className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-4 hover:shadow-md transition-shadow">
